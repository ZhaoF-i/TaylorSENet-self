...
class BatchDataLoader(object):
    ...
    def collate_fn(batch):
        ...
        mixture_2k = torch.tensor(librosa.resample(y=mixture.data.numpy(), orig_sr=16000, target_sr=2000))
        noise_2k = torch.tensor(librosa.resample(y=noise.data.numpy(), orig_sr=16000, target_sr=2000))
        mask_for_loss = pad_sequence(mask_for_loss, batch_first=True)
        return [mixture, speech, noise, mask_for_loss, nframe, nsample, mixture_2k, noise_2k]
